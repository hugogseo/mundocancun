...
export function PackageEditForm({ packageData, categories }: PackageEditFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    price_base: packageData.price_base?.toString() || "0",
    duration_nights: packageData.duration_nights?.toString() || "1",
    min_guests: packageData.min_guests?.toString() || "1",
    max_guests: packageData.max_guests?.toString() || "2",
